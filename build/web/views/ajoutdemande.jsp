        ...
        <div class="col-lg-10 stretch-card">
          <div class="card">
            <div class="card-body">
                  ...
                  <form action="../dem" method="GET">
                    <div class="form-group">
                      <label for="exampleInputName1"> Nom</label>
                      <input type="text" class="form-control" id="exampleInputName1" placeholder="Nom et Prénom" name="nom">
                    </div>
                                          <div class="form-group">
                      <label for="exampleInputName1"> Prénom </label>
                      <input type="text" class="form-control" id="exampleInputName1" placeholder="Nom et Prénom" name="prenom">
                    </div>
                    <div class="form-group">
